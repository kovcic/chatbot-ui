...
AS $$
DECLARE
  project_url TEXT := 'https://rclxqpxrfclyfcxmhphw.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJjbHhxcHhyZmNseWZjeG1ocGh3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwODk2Mzc0MSwiZXhwIjoyMDI0NTM5NzQxfQ.Bnmb1GeDgDZnNjOOlikl_NRas5uDgvvZCAQ_YQME1J0'; -- full access needed for http request to storage
