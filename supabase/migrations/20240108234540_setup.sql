...
AS $$
DECLARE
  project_url TEXT := 'https://iddwpjkokyjwvznqaxjg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlkZHdwamtva3lqd3Z6bnFheGpnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTA0MjY3MSwiZXhwIjoyMDI0NjE4NjcxfQ.QfsNakMNXeQ73OkXq3JLiD-LOrew06NLzb_Rzsijisw'; -- full access needed for http request to storage
